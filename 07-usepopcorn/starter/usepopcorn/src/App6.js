...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  //   hook inside a conditional block

  // change fo element tree because of an early return
  //   if (imdbRating > 8) return <p>Greatest evey!</p>;

  //   const [isTop, setisTop] = useState(imdbRating > 8);
  //   //   whatever we pass on to the hooks will be the initial state is like the initial mount. during initial mount imdbrating is undefied
  //   console.log(isTop);
  //   useEffect(
  //     function () {
